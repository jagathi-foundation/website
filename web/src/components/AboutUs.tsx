    ...
    <div style={{ marginTop: "9.6rem" }}>
      ...
      >
        ...
        <p className="text-left">
          ...
          <p>
            <blockquote className="my-4 font-bold text-xl">
          ...
          <p>
            Number of people suffering from the major and severe health problems
            in rural sections and urban slums. The biggest reason of these
            health disparities here is malnutrition and pathetic slum living
            facilities. The air they breathe, the water they drink and even food
            they eat are totally contrary and pathetic to the normal and healthy
            living facilities. Jagathi Foundation support basic health and
            social needs of underprivileged sections of the society like poor,
            women, elderly, children etc with awareness on hygiene, nutrition
